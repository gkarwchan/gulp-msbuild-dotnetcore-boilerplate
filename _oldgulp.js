...
varÂ nugetÂ =Â Nuget({
    nugetPath:Â nugetPath,
    configFile:Â 'Nuget.config'
});
...
gulp.task('assemblyInfo', function() {
    return gulp.src('**/AssemblyInfo.cs')
        .pipe(assemblyInfo({
            ...
            copyright: 'Copyright Â© Shaw Communications Inc.', 
            trademark: 'Shaw', 
...
<package >
  <metadata>
    ...
    <copyright>Copyright Â© Shaw Communications Inc.</copyright>
  </metadata>
</package>`;
}